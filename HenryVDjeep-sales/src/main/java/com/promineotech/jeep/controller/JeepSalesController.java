...
public interface JeepSalesController {
  @Operation(
		  ...
		  description = "Returns a list of Jeeps given a trim and/or a model",
		  responses = {
				  @ApiResponse(responseCode = "200", description = "Success", 
						  content = @Content(mediaType = "application/json", 
						  schema = @Schema(implementation = Jeep.class))),
				  @ApiResponse(responseCode = "400", description = "Something Fail", 
				  content = @Content(mediaType = "application/json")),
				  @ApiResponse(responseCode = "404", description = "No Jeeps Found", 
				  content = @Content(mediaType = "application/json")),
		  ...
		  parameters = {
				...
				required = false, description = "Model name"),
				  @Parameter(name = "trim", allowEmptyValue = false, 
				required = false, description = "Trim type")
		  }
		  ) 
  @GetMapping
